...
var $sillabe = [
    ...
    { 'group': 'CDURA', 'vocale': 'A', 'name': 'CA', 's1': 'C', 's2': 'A', 'audioSillaba': 'assets/sounds/sillabe/ca.mp3', 'audioScandito': '' },
    { 'group': 'CDURA', 'vocale': 'E', 'name': 'CHE', 's1': 'C', 's2': 'HE', 'audioSillaba': 'assets/sounds/sillabe/che.mp3', 'audioScandito': '' },
    { 'group': 'CDURA', 'vocale': 'I', 'name': 'CHI', 's1': 'C', 's2': 'HI', 'audioSillaba': 'assets/sounds/sillabe/chi.mp3', 'audioScandito': '' },
    { 'group': 'CDURA', 'vocale': 'O', 'name': 'CO', 's1': 'C', 's2': 'O', 'audioSillaba': 'assets/sounds/sillabe/co.mp3', 'audioScandito': '' },
    { 'group': 'CDURA', 'vocale': 'U', 'name': 'CU', 's1': 'C', 's2': 'U', 'audioSillaba': 'assets/sounds/sillabe/cu.mp3', 'audioScandito': '' },

    { 'group': 'CDOLCE', 'vocale': 'A', 'name': 'CIA', 's1': 'C', 's2': 'IA', 'audioSillaba': 'assets/sounds/sillabe/cia.mp3', 'audioScandito': '' },
    { 'group': 'CDOLCE', 'vocale': 'E', 'name': 'CE', 's1': 'C', 's2': 'E', 'audioSillaba': 'assets/sounds/sillabe/ce.mp3', 'audioScandito': '' },
    { 'group': 'CDOLCE', 'vocale': 'I', 'name': 'CI', 's1': 'C', 's2': 'I', 'audioSillaba': 'assets/sounds/sillabe/ci.mp3', 'audioScandito': '' },
    { 'group': 'CDOLCE', 'vocale': 'O', 'name': 'CIO', 's1': 'C', 's2': 'IO', 'audioSillaba': 'assets/sounds/sillabe/cio.mp3', 'audioScandito': '' },
    { 'group': 'CDOLCE', 'vocale': 'U', 'name': 'CIU', 's1': 'C', 's2': 'IU', 'audioSillaba': 'assets/sounds/sillabe/ciu.mp3', 'audioScandito': '' },
    ...
    { 'group': 'GDURA', 'vocale': 'A', 'name': 'GA', 's1': 'G', 's2': 'A', 'audioSillaba': 'assets/sounds/sillabe/ga.mp3', 'audioScandito': '' },
    { 'group': 'GDURA', 'vocale': 'E', 'name': 'GHE', 's1': 'G', 's2': 'HE', 'audioSillaba': 'assets/sounds/sillabe/ghe.mp3', 'audioScandito': '' },
    { 'group': 'GDURA', 'vocale': 'I', 'name': 'GHI', 's1': 'G', 's2': 'HI', 'audioSillaba': 'assets/sounds/sillabe/ghi.mp3', 'audioScandito': '' },
    { 'group': 'GDURA', 'vocale': 'O', 'name': 'GO', 's1': 'G', 's2': 'O', 'audioSillaba': 'assets/sounds/sillabe/go.mp3', 'audioScandito': '' },
    { 'group': 'GDURA', 'vocale': 'U', 'name': 'GU', 's1': 'G', 's2': 'U', 'audioSillaba': 'assets/sounds/sillabe/gu.mp3', 'audioScandito': '' },

    { 'group': 'GDOLCE', 'vocale': 'A', 'name': 'GIA', 's1': 'G', 's2': 'IA', 'audioSillaba': 'assets/sounds/sillabe/gia.mp3', 'audioScandito': '' },
    { 'group': 'GDOLCE', 'vocale': 'E', 'name': 'GE', 's1': 'G', 's2': 'E', 'audioSillaba': 'assets/sounds/sillabe/ge.mp3', 'audioScandito': '' },
    { 'group': 'GDOLCE', 'vocale': 'I', 'name': 'GI', 's1': 'G', 's2': 'I', 'audioSillaba': 'assets/sounds/sillabe/gi.mp3', 'audioScandito': '' },
    { 'group': 'GDOLCE', 'vocale': 'O', 'name': 'GIO', 's1': 'G', 's2': 'IO', 'audioSillaba': 'assets/sounds/sillabe/gio.mp3', 'audioScandito': '' },
    { 'group': 'GDOLCE', 'vocale': 'U', 'name': 'GIU', 's1': 'G', 's2': 'IU', 'audioSillaba': 'assets/sounds/sillabe/giu.mp3', 'audioScandito': '' },
